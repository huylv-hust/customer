        ...
        <div class="row">
            ...
            <div style="margin-bottom: 20px">
                <div class="form-group">
                    <input type="hidden" id="district_hidden"
                           value="{{isset($filter['district_id'])? $filter['district_id'] : ''}}">
                ...
                <div class="form-group">
                    ...
                    <input style="height: 32px" class="form-control" id="town" name="name" placeholder="Name"
